(() => {
  ...
  const MODEL_URL = window.ASTRAGALE_MODEL_URL || "../assets/models/astragale/astragalus_holes_anchors_copy.glb";
  ...
  const I18N = {
    fr: {
      ...
      missingThree: "Three.js ou GLTFLoader n'est pas chargé. Vérifie les fichiers locaux du prototype.",
    ...
    en: {
      ...
      missingThree: "Three.js or GLTFLoader is not loaded. Check the local prototype files.",
    ...
    de: {
      ...
      missingThree: "Three.js oder GLTFLoader ist nicht geladen. Prüfe die lokalen Dateien des Prototyps.",
    ...
    it: {
      langName: "Italiano",
      eyebrow: "Prototipo del sito - modello 3D reale",
      title: "Scrivere con le ossa - Filo e alfabeto",
      intro: "Un osso forato può nascondere un messaggio. Ruota l'astragalo, segui il filo e ritrova la parola segreta.",
      badges: ["Prototipo pedagogico", "Storia antica", "3D interattivo", "Da migliorare / in stabilizzazione"],
      tutorialTitle: "Tutorial",
      tutorial: ["Ruota l'oggetto.", "Trova l'inizio del filo.", "Clicca i fori nell'ordine per rivelare le lettere."],
      distinctionTitle: "Storico o adattato?",
      historical: "Storico: Enea il Tattico, nel IV secolo a.C., descrive un astragalo perforato con 24 fori, sei su ogni faccia. I fori corrispondono alle 24 lettere greche. Un filo passa nei fori del messaggio; chi riceve segue o scioglie il filo per leggere le lettere.",
      adapted: "Adattamento pedagogico: questo prototipo usa lettere latine e parole della lingua della pagina su 24 posizioni, per conservare i 24 fori. Non viene presentato come il sistema greco antico.",
      recenter: "Ricentrare",
      nextFace: "Faccia successiva",
      zoomOut: "Zoom indietro",
      zoomIn: "Zoom avanti",
      levelTitle: "Progressione",
      level: "Livello",
      helperTitle: "Aiuti opzionali",
      xray: "Modo raggi X",
      wordHint: "Indizio sulla parola",
      score: "Punteggio",
      helps: "Aiuti",
      mistakes: "Errori",
      answerTitle: "Risposta",
      validate: "Convalidare",
      undo: "Annullare un foro",
      faceTitle: "Mappa delle facce",
      faceNote: "La mappa indica la faccia osservata e i fori già scelti. Non dà automaticamente la soluzione.",
      resultTitle: "Bilancio",
      nextWord: "Parola successiva",
      targetWord: "Parola da scrivere",
      bravo: "Bravo!",
      stageNote: "Mouse/tocco: trascina per ruotare, rotella per zoomare. Tastiera: frecce per ruotare, WASD per spostare la vista, +/-, R, F, Invio.",
      loading: "Caricamento del modello astragalus_holes_anchors_copy.glb e degli anchor Hole_*...",
      missingThree: "Three.js o GLTFLoader non è caricato. Verifica i file locali del prototipo.",
      missingAnchors: "Il modello è caricato, ma i 24 anchor Hole_* non sono stati trovati.",
      loaded: count => `Modello caricato: ${count} anchor di fori rilevati.`,
      feedbackStart: "Segui il filo dal nodo dorato, poi clicca il primo foro.",
      feedbackCorrect: "Foro corretto. Continua a seguire il filo.",
      feedbackReady: "La parola è completa. Puoi convalidare.",
      feedbackWrong: "Questo foro non corrisponde alla prossima lettera. Osserva il filo e la faccia attiva.",
      feedbackTooShort: "Mancano ancora alcune lettere. Segui il filo fino al prossimo foro.",
      feedbackSuccess: "Bravo, il messaggio è stato ritrovato.",
      hint: "Indizio",
      found: "Parola",
      translation: "Traduzione",
      modernNotice: "Adattamento pedagogico moderno, non storico.",
      faceNames: { bassin: "Bacino", dos: "Dorso", membres: "Arti", ventre: "Ventre" }
    }
  };
  ...
  const UI_PATCH = {
    ...
    it: {
      tutorial: [
        "Esempi da 1 a 4: clicca i fori nell'ordine della parola data.",
        "La mappa lettere-fori indica quale lettera corrisponde a ogni foro.",
        "Modo decodifica: segui il filo, leggi le lettere sulla mappa, poi digita la parola trovata."
      ],
      helperTitle: "Opzioni utili",
      xray: "Vedere il filo dietro l'osso",
      wordHint: "Indizio",
      faceTitle: "Mappa lettere-fori",
      faceNote: "Mappa precompilata: ogni lettera indica il foro corrispondente. Nel modo decodifica serve a leggere il filo senza mostrare lettere sull'osseletto.",
      targetWord: "Parola da scrivere",
      decodeTargetWord: "Parola da decodificare",
      decodePlaceholder: "Digita la parola trovata",
      clearAnswer: "Cancellare",
      feedbackStart: "Clicca i fori nell'ordine della parola visualizzata.",
      feedbackDecodeStart: "Segui il filo, leggi le lettere sulla mappa, poi digita la parola trovata.",
      feedbackDecodeWrong: "Non è ancora la parola giusta. Confronta ogni foro collegato con la mappa delle lettere.",
      feedbackDecodeSuccess: "Bravo, la parola codificata dal filo è stata ritrovata.",
      faceRecto: "Recto",
      faceVerso: "Verso",
      mapSideNote: "lettere visibili sulla mappa, non sull'osseletto",
      writeResult: "Esempio di scrittura: il filo collega i fori della parola data.",
      decodeResult: "Decodifica: la parola si legge seguendo il filo e la mappa delle lettere."
    }
  };
  ...
  const LEVELS = [
    {
      id: 1, mode: "write",
      navTitle: { fr: "Exemple 1", en: "Example 1", de: "Beispiel 1", it: "Esempio 1" },
      words: { fr: "OBJET", en: "BONES", de: "FADEN", it: "OSSEO" },
      translations: { fr: "mot donné pour apprendre à passer le fil", en: "given word for learning the thread path", de: "vorgegebenes Wort zum Führen des Fadens", it: "parola data per imparare a far passare il filo" },
      hint: { fr: "Suis simplement les lettres du mot affiché.", en: "Just follow the letters of the displayed word.", de: "Folge einfach den Buchstaben des angezeigten Wortes.", it: "Segui semplicemente le lettere della parola visualizzata." },
      setup: { showLetters: true, partialLetters: false },
      label: { fr: "Écrire OBJET", en: "Write BONES", de: "FADEN schreiben", it: "Scrivere OSSEO" }
    },
    {
      id: 2, mode: "write",
      navTitle: { fr: "Exemple 2", en: "Example 2", de: "Beispiel 2", it: "Esempio 2" },
      words: { fr: "FIBRE", en: "THREAD", de: "FASER", it: "FIBRA" },
      translations: { fr: "le fil ou la matière qui relie les trous", en: "the thread that links the holes", de: "Faser oder Fadenmaterial, das die Löcher verbindet", it: "il filo o la materia che collega i fori" },
      hint: { fr: "Cherche chaque lettre sur l'osselet puis clique le trou.", en: "Find each letter on the astragalus, then click its hole.", de: "Suche jeden Buchstaben auf dem Astragalus und klicke sein Loch.", it: "Cerca ogni lettera sull'osseletto, poi clicca il foro." },
      setup: { showLetters: true, partialLetters: false },
      label: { fr: "Écrire FIBRE", en: "Write THREAD", de: "FASER schreiben", it: "Scrivere FIBRA" }
    },
    {
      id: 3, mode: "write",
      navTitle: { fr: "Exemple 3", en: "Example 3", de: "Beispiel 3", it: "Esempio 3" },
      words: { fr: "SIGNE", en: "CODES", de: "CODES", it: "SEGNO" },
      translations: { fr: "un signe porte une information", en: "marks can carry information", de: "Codes als geordnete Zeichen", it: "un segno può portare un'informazione" },
      hint: { fr: "Le fil transforme une suite de trous en message.", en: "The thread turns a sequence of holes into a message.", de: "Der Faden verwandelt eine Lochfolge in eine Botschaft.", it: "Il filo trasforma una sequenza di fori in un messaggio." },
      setup: { showLetters: true, partialLetters: false },
      label: { fr: "Écrire SIGNE", en: "Write CODES", de: "CODES schreiben", it: "Scrivere SEGNO" }
    },
    {
      id: 4, mode: "write",
      navTitle: { fr: "Exemple 4", en: "Example 4", de: "Beispiel 4", it: "Esempio 4" },
      words: { fr: "TRACE", en: "TOKEN", de: "DINGE", it: "TRAMA" },
      translations: { fr: "trace laissée par le fil", en: "a small sign carrying meaning", de: "Dinge, objets à observer", it: "traccia lasciata dal filo" },
      hint: { fr: "Dernier exemple guidé avant de lire un mot sans lettres sur l'osselet.", en: "Last guided example before reading a word without letters on the astragalus.", de: "Letztes geführtes Beispiel vor dem Lesen ohne Buchstaben auf dem Astragalus.", it: "Ultimo esempio guidato prima di leggere una parola senza lettere sull'osseletto." },
      setup: { showLetters: true, partialLetters: false },
      label: { fr: "Écrire TRACE", en: "Write TOKEN", de: "DINGE schreiben", it: "Scrivere TRAMA" }
    },
    {
      id: 5, mode: "decode",
      navTitle: { fr: "Décoder", en: "Decode", de: "Decodieren", it: "Decodificare" },
      words: {
        ...
        it: ["OSSEO", "FIBRA", "SEGNO", "TRAMA", "CODICE", "INDICE", "MAPPA", "FORMA", "PUNTO", "RESTO"]
      },
      translations: { fr: "mot à lire grâce au fil et à la carte", en: "word to read from the thread and map", de: "Wort, das mit Faden und Karte gelesen wird", it: "parola da leggere grazie al filo e alla mappa" },
      hint: { fr: "Observe les trous traversés par le fil, puis reporte-toi à la carte.", en: "Look at the holes crossed by the thread, then use the map.", de: "Beobachte die Löcher am Faden und nutze dann die Karte.", it: "Osserva i fori attraversati dal filo, poi usa la mappa." },
      setup: { showLetters: false, partialLetters: false },
      label: { fr: "10 mots à trouver, sans lettres sur l'osselet", en: "10 words to find, no letters on the astragalus", de: "10 Wörter finden, ohne Buchstaben auf dem Astragalus", it: "10 parole da trovare, senza lettere sull'osseletto" }
    }
  ];
