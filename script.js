...
const textTranslations = {
  de: {
    ...
    "École et musée": "Schule und Museum",
    "45 min": "45 Min.",
    "Activité 2 — À quel animal appartient cet astragale ?": "Aktivität 2 — Zu welchem Tier gehört dieser Astragalus?",
    "Les élèves observent plusieurs astragales, construisent des critères de comparaison, les associent à des animaux et justifient leurs propositions avec plusieurs indices.": "Die Schülerinnen und Schüler beobachten mehrere Astragali, entwickeln Vergleichskriterien, ordnen sie Tieren zu und begründen ihre Vorschläge mit mehreren Hinweisen.",
    "Décrire avant de deviner.": "Beschreiben, bevor man rät.",
    "Comparer plusieurs caractères.": "Mehrere Merkmale vergleichen.",
    "Associer et argumenter.": "Zuordnen und argumentieren.",
    "Évaluer son degré de certitude.": "Den Grad der Sicherheit einschätzen.",
    "50 min ou 2 séances": "50 Min. oder 2 Sitzungen",
    "Activité 3 — Achille : comment une histoire se transforme-t-elle ?": "Aktivität 3 — Achilles: Wie verändert sich eine Geschichte?",
    "Les élèves observent des images, étudient un schéma du talus, ordonnent des cartes chronologiques et construisent un album collectif sur la transformation du \"talon d'Achille\".": "Die Schülerinnen und Schüler betrachten Bilder, untersuchen ein Talus-Schema, ordnen Chronologiekarten und erstellen ein gemeinsames Album zur Verwandlung der \"Achillesferse\".",
    "Observer une image avant de l'interpréter.": "Ein Bild beobachten, bevor man es deutet.",
    "Distinguer les versions et les périodes.": "Versionen und Zeiträume unterscheiden.",
    "Relier mythe, vocabulaire et anatomie.": "Mythos, Wortschatz und Anatomie verbinden.",
    "Produire une page documentaire sourcée.": "Eine belegte Dokumentarseite erstellen.",
    "Activité 4 — Un os, plusieurs vies": "Aktivität 4 — Ein Knochen, mehrere Leben",
    "Les élèves observent des astragales naturels ou transformés, confrontent plusieurs hypothèses d'usage et utilisent le contexte archéologique pour produire un cartel argumenté.": "Die Schülerinnen und Schüler beobachten natürliche oder veränderte Astragali, prüfen mehrere Nutzungshypothesen und nutzen den archäologischen Kontext, um ein begründetes Museumsschild zu verfassen.",
    "Décrire avant d'interpréter.": "Beschreiben, bevor man deutet.",
    "Rechercher les traces de transformation.": "Nach Spuren der Bearbeitung suchen.",
    "Utiliser le contexte.": "Den Kontext nutzen.",
    "Comparer plusieurs hypothèses.": "Mehrere Hypothesen vergleichen.",
    "Rédiger un cartel prudent.": "Ein vorsichtig formuliertes Museumsschild verfassen.",
    ...
    "Dossier complet — Activité 2": "Vollständiges Dossier — Aktivität 2",
    "Cartes, fiches d'observation, grille d'association, guides adultes, correction raisonnée et exemple de production.": "Karten, Beobachtungsblätter, Zuordnungstafel, Leitfäden für Erwachsene, begründete Korrektur und Produktionsbeispiel.",
    "Dossier complet — Activité 3": "Vollständiges Dossier — Aktivität 3",
    "Corpus d'images, schéma anatomique, questionnaire, cartes chronologiques, guides adultes, corrigé et modèle d'album collectif.": "Bildkorpus, anatomisches Schema, Fragebogen, Chronologiekarten, Leitfäden für Erwachsene, Lösung und Vorlage für ein gemeinsames Album.",
    "Dossier complet — Activité 4": "Vollständiges Dossier — Aktivität 4",
    "Cartes d'objets, cartes d'usages et de contextes, fiches d'observation, biographie d'objet, guides adultes, correction et exemple de production.": "Objektkarten, Nutzungs- und Kontextkarten, Beobachtungsblätter, Objektbiografie, Erwachsenenleitfäden, Lösung und Produktionsbeispiel.",
    ...
    "Activités visibles sur le site, prêtes à compléter avec images, cartes et modèles validés.": "Auf der Website sichtbare Aktivitäten, bereit zur Ergänzung mit validierten Bildern, Karten und Modellen.",
  ...
  it: {
    ...
    "École et musée": "Scuola e museo",
    "45 min": "45 min",
    "Activité 2 — À quel animal appartient cet astragale ?": "Attività 2 — A quale animale appartiene questo astragalo?",
    "Les élèves observent plusieurs astragales, construisent des critères de comparaison, les associent à des animaux et justifient leurs propositions avec plusieurs indices.": "Gli allievi osservano diversi astragali, costruiscono criteri di confronto, li associano agli animali e giustificano le proposte con più indizi.",
    "Décrire avant de deviner.": "Descrivere prima di indovinare.",
    "Comparer plusieurs caractères.": "Confrontare più caratteri.",
    "Associer et argumenter.": "Associare e argomentare.",
    "Évaluer son degré de certitude.": "Valutare il proprio grado di certezza.",
    "50 min ou 2 séances": "50 min o 2 lezioni",
    "Activité 3 — Achille : comment une histoire se transforme-t-elle ?": "Attività 3 — Achille: come si trasforma una storia?",
    "Les élèves observent des images, étudient un schéma du talus, ordonnent des cartes chronologiques et construisent un album collectif sur la transformation du \"talon d'Achille\".": "Gli allievi osservano immagini, studiano uno schema del talo, ordinano carte cronologiche e costruiscono un album collettivo sulla trasformazione del \"tallone d'Achille\".",
    "Observer une image avant de l'interpréter.": "Osservare un'immagine prima di interpretarla.",
    "Distinguer les versions et les périodes.": "Distinguere versioni e periodi.",
    "Relier mythe, vocabulaire et anatomie.": "Collegare mito, lessico e anatomia.",
    "Produire une page documentaire sourcée.": "Produrre una pagina documentaria con fonti.",
    "Activité 4 — Un os, plusieurs vies": "Attività 4 — Un osso, più vite",
    "Les élèves observent des astragales naturels ou transformés, confrontent plusieurs hypothèses d'usage et utilisent le contexte archéologique pour produire un cartel argumenté.": "Gli allievi osservano astragali naturali o trasformati, confrontano diverse ipotesi d'uso e usano il contesto archeologico per produrre un cartellino argomentato.",
    "Décrire avant d'interpréter.": "Descrivere prima di interpretare.",
    "Rechercher les traces de transformation.": "Cercare le tracce di trasformazione.",
    "Utiliser le contexte.": "Usare il contesto.",
    "Comparer plusieurs hypothèses.": "Confrontare più ipotesi.",
    "Rédiger un cartel prudent.": "Redigere un cartellino prudente.",
    ...
    "Dossier complet — Activité 2": "Dossier completo — Attività 2",
    "Cartes, fiches d'observation, grille d'association, guides adultes, correction raisonnée et exemple de production.": "Carte, schede di osservazione, griglia di associazione, guide per adulti, correzione ragionata ed esempio di produzione.",
    "Dossier complet — Activité 3": "Dossier completo — Attività 3",
    "Corpus d'images, schéma anatomique, questionnaire, cartes chronologiques, guides adultes, corrigé et modèle d'album collectif.": "Corpus di immagini, schema anatomico, questionario, carte cronologiche, guide per adulti, correzione e modello di album collettivo.",
    "Dossier complet — Activité 4": "Dossier completo — Attività 4",
    "Cartes d'objets, cartes d'usages et de contextes, fiches d'observation, biographie d'objet, guides adultes, correction et exemple de production.": "Carte degli oggetti, carte degli usi e dei contesti, schede di osservazione, biografia dell'oggetto, guide per adulti, correzione ed esempio di produzione.",
    ...
    "Activités visibles sur le site, prêtes à compléter avec images, cartes et modèles validés.": "Attività visibili sul sito, pronte da completare con immagini, carte e modelli validati.",
  ...
  en: {
    ...
    "École et musée": "School and museum",
    "45 min": "45 min",
    "Activité 2 — À quel animal appartient cet astragale ?": "Activity 2 — Which animal does this astragalus belong to?",
    "Les élèves observent plusieurs astragales, construisent des critères de comparaison, les associent à des animaux et justifient leurs propositions avec plusieurs indices.": "Pupils observe several astragali, build comparison criteria, associate them with animals and justify their proposals with several clues.",
    "Décrire avant de deviner.": "Describe before guessing.",
    "Comparer plusieurs caractères.": "Compare several features.",
    "Associer et argumenter.": "Associate and argue.",
    "Évaluer son degré de certitude.": "Assess one's degree of certainty.",
    "50 min ou 2 séances": "50 min or 2 sessions",
    "Activité 3 — Achille : comment une histoire se transforme-t-elle ?": "Activity 3 — Achilles: how does a story change?",
    "Les élèves observent des images, étudient un schéma du talus, ordonnent des cartes chronologiques et construisent un album collectif sur la transformation du \"talon d'Achille\".": "Pupils observe images, study a talus diagram, order chronology cards and build a shared album about the transformation of the \"Achilles heel\".",
    "Observer une image avant de l'interpréter.": "Observe an image before interpreting it.",
    "Distinguer les versions et les périodes.": "Distinguish versions and periods.",
    "Relier mythe, vocabulaire et anatomie.": "Connect myth, vocabulary and anatomy.",
    "Produire une page documentaire sourcée.": "Produce a sourced documentary page.",
    "Activité 4 — Un os, plusieurs vies": "Activity 4 — One bone, several lives",
    "Les élèves observent des astragales naturels ou transformés, confrontent plusieurs hypothèses d'usage et utilisent le contexte archéologique pour produire un cartel argumenté.": "Pupils observe natural or transformed astragali, compare several usage hypotheses and use the archaeological context to produce an argued museum label.",
    "Décrire avant d'interpréter.": "Describe before interpreting.",
    "Rechercher les traces de transformation.": "Look for traces of transformation.",
    "Utiliser le contexte.": "Use the context.",
    "Comparer plusieurs hypothèses.": "Compare several hypotheses.",
    "Rédiger un cartel prudent.": "Write a cautious museum label.",
    ...
    "Dossier complet — Activité 2": "Complete dossier — Activity 2",
    "Cartes, fiches d'observation, grille d'association, guides adultes, correction raisonnée et exemple de production.": "Cards, observation sheets, association grid, adult guides, reasoned correction and sample production.",
    "Dossier complet — Activité 3": "Complete dossier — Activity 3",
    "Corpus d'images, schéma anatomique, questionnaire, cartes chronologiques, guides adultes, corrigé et modèle d'album collectif.": "Image corpus, anatomy diagram, questionnaire, chronology cards, adult guides, answer key and shared album template.",
    "Dossier complet — Activité 4": "Complete dossier — Activity 4",
    "Cartes d'objets, cartes d'usages et de contextes, fiches d'observation, biographie d'objet, guides adultes, correction et exemple de production.": "Object cards, usage and context cards, observation sheets, object biography, adult guides, answer key and sample production.",
    ...
    "Activités visibles sur le site, prêtes à compléter avec images, cartes et modèles validés.": "Activities visible on the site, ready to complete with validated images, cards and models.",
